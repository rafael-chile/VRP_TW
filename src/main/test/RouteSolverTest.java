...
public class RouteSolverTest {
    ...
    private static int nbVehicles = 16;         /* total vehicle fleet
    ...
    private static int nbCustomers = 10;  /* NOT including depot client 0
    ...
    private static int[][] costs = new int[][]     /* costs in distance ALL to ALL customers */        //consumptions
            ...
            {{0,462,282,635,227,180,468,331,713,277,653},
                    {4,0,988,378,195,305,693,374,415,228,499},
                    {282,988,0,612,172,774,705,791,959,187,742},
                    {635,378,612,0,973,604,520,339,118,556,335},
                    {227,195,172,973,0,130,525,348,726,572,235},
                    {180,305,774,604,130,0,432,787,259,423,865},
                    {468,693,705,520,525,432,0,515,581,425,234},
                    {331,374,791,339,348,787,515,0,186,46,613},
                    {713,415,959,118,726,259,581,186,0,300,783},
                    {277,228,187,556,572,423,425,46,300,0,403},
                    {653,499,742,335,235,865,234,613,783,403,0}};
    ...
    private static int[][] travTime = new int[][]      /* costs in time ALL to ALL customers */
            ...
            { /*0*/ {0,46,22,65,27,10,48,31,73,27,53},
                    {10,0,98,38,95,25,63,74,15,28,49},
                    {22,98,0,12,72,77,70,71,99,87,72},
                    {65,38,62,0,93,64,50,39,18,56,35},
                    {27,95,72,73,0,10,25,48,76,52,25},
                    {10,35,74,04,10,0,42,77,29,43,85},
                    {46,93,75,20,25,42,0,55,51,45,24},
                    {31,74,91,39,48,77,55,0,86,4,61},
                    {73,45,59,18,76,29,51,16,0,30,73},
                    {27,28,87,56,52,23,45,46,30,0,43},
                    {63,49,72,35,25,85,24,63,73,43,0}};
    ...
    /*6*/  {0, 500}, /*7*/  {10, 400}, /*8*/  {10, 500}, /*9*/  {40, 500}, /*10*/ {25, 400}
            };
